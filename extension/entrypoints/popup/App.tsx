...
import { Brain, MousePointerClick, ExternalLink, NotebookPen } from "lucide-react";
...
function App() {
  ...
  function openNeedsAttention() {
    const attentionUrl = browser.runtime.getURL("/attention.html");
    browser.tabs.create({ url: attentionUrl });
  }
        ...
        <div className="space-y-3.5">
          <header className="flex items-center justify-between pb-1.5 border-b border-border/40">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-xs font-bold tracking-tight text-foreground cursor-pointer select-none">
                Brain2
              </span>
            </div>
            ...
            <div className="flex items-center gap-1">
              <Button
                ...
                onClick={openNeedsAttention}
              >
                <Brain className={`size-3 ${needsAttention > 0 ? "text-destructive animate-pulse" : ""}`} />
                Attention
                {needsAttention > 0 && (
